      ...
      <div class="col-8">
        <form method="POST" action="{{ route('register') }}">
          ...
          <div class="form-row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="small mb-1" for="inputImage"> Photo</label>
                <input class="form-control py-4 @error('photo') is-invalid @enderror" id="inputImage" type="file" name="photo" value="{{ old('photo') }}" required autocomplete="photo" autofocus />
                @error('name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control py-4 @error('cv') is-invalid @enderror" id="cv" type="text" name="cv" value="{{ old('cv') }}" required autocomplete="cv" autofocus />
                @error('phone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class=" mt-3 text-center ">
          <a href="{{ route('seekerlogin') }}" class="loginLink text-decoration-none">Have an account? Go to login</a>
        </div>
      </div>
    </div>
  </div>
