            ...
            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 border text-left scrollarea">
                ...
                <div class="p-3 my-3">
                    ...
                    <select class="form-control fexp">
                        ...
                        <option value="1" @if($expid==1) selected @endif>
                            under 3 years</option>
                        <option value="2" @if($expid==2) selected @endif>3-6 years</option>
                        <option value="3" @if($expid==3) selected @endif>6-9 years</option>
                        <option value="4" @if($expid==4) selected @endif>above 9 years</option>
                ...
                <div class="col-12 my-2">
                    ...
                    <select class="form-control fsal">
                        ...
                        <option value="1">under 500000 kyats</option>
                        <option value="2">500000-999999 Kyats</option>
                        <option value="3">1000000-1499999 Kyats</option>
